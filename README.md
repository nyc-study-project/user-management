Notes for sprint 3 deployment: Database schema has changed (see schema section) + a redirect uri to callback endpoint must be added in gcp (local example available in gcp).
